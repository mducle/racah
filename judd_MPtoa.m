...
a = [( 4*(  55*M(1) -      44*M(2) -        50*M(3) )/165                                                    );   % a1
     ...
     (   (  27*M(1) -       5*M(2) -   (25/11)*M(3) )/24 + P(1)/3 +    1*( 35*P(2) + 77*P(3) + 143*P(4) )/16 );   % a12
     (   ( -33*M(1) + (15/11)*M(2) +   (15/11)*M(3) )             +    3*( 35*P(2) + 77*P(3) + 143*P(4) )/2  );   % a13
     (   (  12*M(1) -   (2/3)*M(2) -   (10/33)*M(3) )/5  + P(1)/3 -    1*( 35*P(2) + 77*P(3) + 143*P(4) )/5  )];  % a14
...
%  +(4/3)*(( 12*M(1) -   (2/3)*M(2) -   (10/33)*M(3) )/5  + P(1)/3 -    1*( 35*P(2) + 77*P(3) + 143*P(4) )/5 ))/8];% a14
